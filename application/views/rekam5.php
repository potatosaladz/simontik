<div class="row">
    <div id="breadcrumb" class="col-xs-12">
        ...
        <ol class="breadcrumb pull-left">
            ...
            <li><a href="#">Rekam Pengumuman</a></li>
        </ol>
    ...
    <fieldset>
            <?php 
                ...
                if(isset($rekam) && $rekam==true && $update==false){
                    echo form_open('berita/simpan');
                }
                if (isset($update) && $update==true && $rekam==false){
                    echo form_open('berita/update');
                }
                

                if(isset($berita) && $berita!=null){
                     foreach ($berita as $row2) {
                         $judul_ubah=$row2['judul'];
                         $isi_ubah=$row2['isi'];
                         $id_ubah=$row2['id'];
                     }
                }
            ...
            ?>
                <input type="hidden" id="id" name="id" value="<?php if(isset($berita) && $berita!=null) echo $id_ubah;  ?>">
                <table id="tbl" align="center">
                    <tr>
                        <td><label for="user">Judul</label></td>
                        <td><input type="text" id="judul" name="judul" class="text ui-widget-content ui-corner-all" value="<?php if(isset($berita) && $berita!=null) echo $judul_ubah;  ?>"/></td>                        
                    </tr>
                    <tr>
                        <td><label for="user">Isi Pengumuman</label></td>
                        <td><textarea name="isi" id="isi" rows="10"><?php if(isset($berita) && $berita!=null) echo $isi_ubah;  ?></textarea></td>                        
                    </tr>
                    <tr>
