...
Class Berita extends CI_Controller {
	...
	public function ubah(){
		...
		$berita=$this->berita_model->getBerita($arr);
	...
	public function simpan(){
		...
		if ($this->form_validation->run() == FALSE) {
			...
			$result = $this->berita_model->Berita_insert($data);
			$berita=$this->berita_model->getAllBerita();
			if ($result == TRUE) {
				$result=array(
					'rekam' => true,
	...
	public function update(){
		...
		if ($this->form_validation->run() == FALSE) {
			...
			$result = $this->berita_model->Berita_update($data,$id);
			$berita=$this->berita_model->getAllBerita();
			if ($result == TRUE) {
				$result=array(
					'rekam' => true,
