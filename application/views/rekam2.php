    ...
    <fieldset>
            ...
            ?>
                ...
                <table id="tbl" align="center">
                    ...
                    <?php
                    if(isset($param_jenis)  && $param_jenis==6){
                    ?>
                        <tr>
                        <td><label>Jenis Printer</label></td>
                        <td colspan="2" >
                            <select name="printer">
                                <?php 
                                    foreach ($printer as $row) {
                                        if(isset($hardware)){
                                            if($row['id']==$printer_ubah){
                                                echo "<option value=".$row['id']." selected>".$row['nmprinter']."</option>";
                                            }else{
                                                echo "<option value=".$row['id'].">".$row['nmprinter']."</option>";
                                            }
                                        }else{
                                            echo "<option value=".$row['id'].">".$row['nmprinter']."</option>";
                                        } 
                    ...
                    <tr>
                        ...
                        <td><input type="text" id="tipe" name="tipe" class="text ui-widget-content ui-corner-all" value="<?php if(isset($hardware)) echo $tipe_ubah;  ?>"/></td>
                        
                    </tr>
                    <tr>
                        <td><label for="user">Nomor Seri</label></td>
                        <td><input type="text" id="sn" name="sn" class="text ui-widget-content ui-corner-all"/ value="<?php if(isset($hardware)) echo $sn_ubah;  ?>"></td>
                        
                    </tr>
                    <tr>
                        <td><label for="user">Kode BMN</label></td>
                        <td><input type="text" id="bmn" name="bmn" class="text ui-widget-content ui-corner-all"/ value="<?php if(isset($hardware)) echo $bmn_ubah;  ?>"></td>
                    ...
                    <tr>
                        ...
                        <td><textarea row="3" id="ket" name="ket" class="text ui-widget-content ui-corner-all" ><?php if(isset($hardware)) echo $ket_ubah;  ?></textarea></td>
                    </tr>
                    <tr>
